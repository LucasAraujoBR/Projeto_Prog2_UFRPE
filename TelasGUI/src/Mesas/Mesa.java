...
public class Mesa implements Comparable<Mesa> {
	 ...
	 * }
	 * 
	 * public int getNumeroPessoas() { return numeroPessoas; } public void
	 * setNumeroPessoas(int numeroPessoas) { this.numeroPessoas = numeroPessoas; }
	 * public int getNumeroDaMesa() { return numeroDaMesa; } public void
	 * setNumeroDaMesa(int numeroDaMesa) { this.numeroDaMesa = numeroDaMesa; }
	 */
